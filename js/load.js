...
Load.prototype = {
	...
	create: function() {
		...
		this.load.onLoadStart.add(this.loadStart, this);//시작 중
		this.load.onFileComplete.add(this.fileComplete, this);//로딩 중
		this.load.onLoadComplete.add(this.loadComplete, this);//로딩 종료
		this.startLoad();
	},
	tips: function(){
		...
		this.title = this.add.text(this.world.centerX, this.setScale(80), '힌트', {font: this.setScale(50)+"px myFont", fill: '#fff'});
		this.title.anchor.set(0.5);

		this.addTips(0, 0, this.setScale(1.3), 'platform0', '일반 보드');
		this.addTips(0, this.setScale(100) * 1, this.setScale(1.3), 'platform3', '일회용 보드');
		this.addTips(0, this.setScale(100) * 2, this.setScale(1.3), 'platform1', '움직이는 보드');
		this.addTips(this.setScale(-10), this.setScale(100) * 3, this.setScale(1.3), 'platform2', '부러진 보드');
		this.addTips(this.setScale(105), this.setScale(100) * 4, this.setScale(1.3), 'bonus0', '스프링')
		this.addTips(this.setScale(40), this.setScale(100) * 5, this.setScale(0.8), 'obstacle4', '블랙홀 ！');
